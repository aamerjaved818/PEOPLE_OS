        ...
        >
          <div className="flex items-center justify-between px-4">
            ...
            <Button
              ...
              className="p-2 text-slate-300 hover:text-slate-600 transition-colors h-auto"
            >
              <Plus size={18} />
            </Button>
          </div>
                ...
                >
                  <div className="flex justify-between items-start mb-6">
                    ...
                    <Button
                      ...
                      className="p-2 text-slate-200 group-hover:text-info transition-colors h-auto"
                    >
                  ...
                  <div className="mt-8 pt-8 border-t border-slate-50 dark:border-slate-700 flex items-center justify-between">
                    ...
                    <Button
                      variant="ghost"
                      onClick={() => onAuditCandidate(candidate)}
                      className="text-primary font-black text-[0.625rem] uppercase tracking-widest flex items-center gap-1 group-hover:gap-3 transition-all h-auto p-0 hover:bg-transparent"
                    >
