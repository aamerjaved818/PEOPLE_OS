        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  className="input-frost w-10 h-10 p-0 rounded cursor-pointer"
                />
            ...
            <div className="space-y-1">
              ...
              <select
                className="w-full input-frost text-sm font-medium focus:ring-2 focus:ring-primary/20 outline-none transition-all"
          ...
          <div className="space-y-1">
            ...
            <textarea
              className="w-full input-frost p-3 min-h-[80px] text-sm outline-none"
