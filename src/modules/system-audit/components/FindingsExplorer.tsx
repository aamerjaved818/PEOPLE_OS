...
import { Search, ArrowUpRight, AlertTriangle, Info, CheckCircle2 } from 'lucide-react';
      ...
      <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
        <div className="relative flex-1 w-full">
          ...
          <input
            ...
            className="input-frost pl-12 pr-4 py-3 text-sm"
        ...
        <div className="flex gap-2 w-full md:w-auto">
          <select
            ...
            className="input-frost px-4 py-3 text-sm"
              ...
              <div className="flex flex-col md:flex-row gap-4 justify-between">
                <div className="space-y-2 flex-1">
                  <div className="flex items-center gap-2">
                    <span
                      className={`px-2 py-0.5 rounded-md text-[0.625rem] font-black uppercase tracking-widest border ${getSeverityStyles(finding.severity)} flex items-center gap-1`}
                    >
