        ...
        <div className="bg-surface/50 backdrop-blur-xl border border-border/50 rounded-2xl p-6 hover:border-primary/30 transition-all group">
          <div className="flex items-start justify-between mb-6">
            ...
            <Button
              ...
              className={`w-12 h-6 rounded-full transition-all relative h-auto p-0 flex items-center ${systemFlags.mfa_enforced ? 'bg-primary shadow-lg shadow-primary/20' : 'bg-muted-bg'}`}
              role="switch"
        ...
        <div className="bg-surface/50 backdrop-blur-xl border border-border/50 rounded-2xl p-6 hover:border-primary/30 transition-all group">
          <div className="flex items-start justify-between mb-6">
            ...
            <Button
              ...
              className={`w-12 h-6 rounded-full transition-all relative h-auto p-0 flex items-center ${systemFlags.biometrics_required ? 'bg-primary' : 'bg-muted-bg'}`}
              role="switch"
        ...
        <div className="bg-surface/50 backdrop-blur-xl border border-border/50 rounded-2xl p-6 hover:border-primary/30 transition-all group overflow-hidden relative">
          ...
          <div className="flex items-start justify-between mb-6">
            ...
            <Button
              ...
              className={`w-12 h-6 rounded-full transition-all relative h-auto p-0 flex items-center ${systemFlags.ip_whitelisting ? 'bg-warning shadow-lg shadow-warning/20' : 'bg-muted-bg'}`}
              role="switch"
          ...
          <Button
            variant="ghost"
            className="text-[0.6rem] font-black text-warning uppercase tracking-widest hover:underline flex items-center gap-1 h-auto p-0 hover:bg-transparent"
          >
        ...
        <div className="bg-surface/50 backdrop-blur-xl border border-border/50 rounded-2xl p-6 hover:border-primary/30 transition-all group">
          <div className="flex items-start justify-between mb-6">
            ...
            <Button
              ...
              className={`w-12 h-6 rounded-full transition-all relative h-auto p-0 flex items-center ${systemFlags.session_isolation ? 'bg-info shadow-lg shadow-info/20' : 'bg-muted-bg'}`}
              role="switch"
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                className="w-full input-frost p-3 text-xs font-bold text-text-primary appearance-none"
            ...
            >
              <div className="flex items-center justify-between mb-2">
                ...
                <Button
                  ...
                  className={`w-8 h-4 rounded-full transition-all relative h-auto p-0 flex items-center ${systemFlags[item.id as keyof typeof systemFlags] ? 'bg-primary' : 'bg-border/50'}`}
                  role="switch"
