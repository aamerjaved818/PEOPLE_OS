...
### Unenforced Foreign Key: 'audit_scores.audit_run_id'

**Dimension:** Database  
**Description:** Column 'audit_run_id' suggests a relation but has no FK constraint.

**Recommendation:** Add FOREIGN KEY constraint for audit_run_id

---

### Unenforced Foreign Key: 'audit_findings.audit_run_id'
...
| Unenforced Foreign Key: 'audit_scores.audit_run_id' | Unassigned | High | TBD |
| Unenforced Foreign Key: 'audit_findings.audit_run_id' | Unassigned | High | TBD |
