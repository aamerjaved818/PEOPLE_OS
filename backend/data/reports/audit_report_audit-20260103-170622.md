...
**Dimension:** AI Layer  
**Description:** Not all AI integrations validate input data (10/37)
...
**Dimension:** AI Layer  
**Description:** Found 36 AI calls without explicit low-temperature settings (risk of hallucinations).
...
**Dimension:** AI Layer  
**Description:** Found 36 AI prompts without grounding constraints.
...
**Dimension:** AI Layer  
**Description:** Found 33 AI calls without response validation.
...
**Dimension:** AI Layer  
**Description:** Less than 50% of AI calls have fallback logic (0/37).
