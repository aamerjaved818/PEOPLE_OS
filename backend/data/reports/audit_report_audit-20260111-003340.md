...
**Dimension:** AI Layer  
**Description:** Not all AI integrations validate input data (9/58)
...
**Dimension:** AI Layer  
**Description:** Found 49 AI calls without explicit low-temperature settings (risk of hallucinations).
...
**Dimension:** AI Layer  
**Description:** Found 57 AI prompts without grounding constraints.
...
**Dimension:** AI Layer  
**Description:** Less than 50% of AI calls have fallback logic (0/58).
