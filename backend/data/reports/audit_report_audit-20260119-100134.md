...
**Date:** 2026-01-19 10:02:03  
**Version:** 1.0.0  
**Scope:** Full System  
**Executed By:** CLI-Runner  
**Execution Time:** 28.6s
...
### Unenforced Foreign Key: 'audit_findings.run_id'

**Dimension:** Database  
**Description:** Column 'run_id' suggests a relation but has no FK constraint.

**Recommendation:** Add FOREIGN KEY constraint for run_id

---

### Unenforced Foreign Key: 'audit_findings.rule_id'

**Dimension:** Database  
**Description:** Column 'rule_id' suggests a relation but has no FK constraint.

**Recommendation:** Add FOREIGN KEY constraint for rule_id
...
**Dimension:** AI Layer  
**Description:** Not all AI integrations validate input data (10/59)
...
**Dimension:** AI Layer  
**Description:** Found 50 AI calls without explicit low-temperature settings (risk of hallucinations).
...
**Dimension:** AI Layer  
**Description:** Found 58 AI prompts without grounding constraints.
...
**Dimension:** AI Layer  
**Description:** Found 53 AI calls without response validation.
...
**Dimension:** AI Layer  
**Description:** Less than 50% of AI calls have fallback logic (0/59).
...
| Unenforced Foreign Key: 'audit_findings.run_id' | Unassigned | High | TBD |
| Unenforced Foreign Key: 'audit_findings.rule_id' | Unassigned | High | TBD |
